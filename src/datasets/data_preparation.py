...
def load_data(dataset_mode="CIFAR10", val_split=False, val_ratio=0.2, conf={}):
    ...
    if val_split:
        ...
        val_ids = rand_ids[val_ids:]  # TODO: val_ids is not defined
...
def split_data(ds, conf):
    ...
    if conf["dataset"] == "StackedMNIST":
        return split_data_from_torchvision(ds, conf['split_mode'], conf['num_clients'])
